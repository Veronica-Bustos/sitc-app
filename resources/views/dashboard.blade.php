<x-layouts.app>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-800 dark:text-gray-100 mt-1">
                        {{ \App\Models\Item::where('status', 'in_use')->count() }}
                    </p>
                    <p class="text-xs text-gray-500 flex items-center mt-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1 text-orange-500" fill="none"
        ...
        <!-- Items In Maintenance Card -->
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('In Maintenance') }}</p>
                    <p class="text-2xl font-bold text-gray-800 dark:text-gray-100 mt-1">
                        {{ \App\Models\Item::where('status', 'in_repair')->count() }}
                    </p>
                    <p class="text-xs text-gray-500 flex items-center mt-1">
        ...
        <!-- Movements This Month Card -->
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Monthly Movements') }}</p>
                    <p class="text-2xl font-bold text-gray-800 dark:text-gray-100 mt-1">
                        {{ \App\Models\InventoryMovement::whereMonth('created_at', now()->month)->whereYear('created_at', now()->year)->count() }}
                    </p>
                    <p class="text-xs text-gray-500 flex items-center mt-1">
